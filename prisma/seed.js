  ...
  for (const [name, slug, categorySlug, pricingType, rating, shortDescription] of tools) {
    ...
    await prisma.tool.create({
      data: {
        ...
        isEditorsPick: ["chatgpt", "claude", "cursor", "perplexity", "github-copilot", "n8n", "elevenlabs", "windsurf", "raycast", "suno", "flux"].includes(slug),
        isHot: ["codex", "v0", "bolt", "replit", "runway", "luma-dream-machine", "sora", "veo", "devin", "granola", "deepseek", "kling", "exa"].includes(slug),
      },
    });
  }
